...
if __name__ == '__main__':
    ...
    valid_cells = pd.read_csv('tingkai-li-early-prediction-varying-usage-data-d1f5535/feature_extraction/valid_cells_paper.csv').values.flatten().tolist()
    
    # Cycling conditions of each group (without DoD) and empirical DoD values for each cell
    cycling_cond = pd.read_csv('tingkai-li-early-prediction-varying-usage-data-d1f5535/feature_extraction/cycling_conditions_wo_DoD.csv')
    empirical_DoD = pd.read_csv('tingkai-li-early-prediction-varying-usage-data-d1f5535/feature_extraction/empirical_DoD.csv')
    ...
    main_dir = '/home/ayushman/ayushman_1/battery'
